...
export const enableLinkTitleFetch = (rootValue['enableLinkTitleFetch'] ?? false) as boolean;
export const enableMarkdownEscaping = (rootValue['enableMarkdownEscaping'] ?? false) as boolean;
